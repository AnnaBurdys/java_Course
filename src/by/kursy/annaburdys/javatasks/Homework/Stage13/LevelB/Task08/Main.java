package by.kursy.annaburdys.javatasks.Homework.Stage13.LevelB.Task08;
...
public class Main {
    public static void main(String[] args) {
        ...
        int counter = Model.countAbsLessThanNumberElements(array, number);

        String msg = String.format("\nAmount of abs less than number elements: %d", counter);
