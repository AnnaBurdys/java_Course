package by.kursy.annaburdys.javatasks.Homework.Stage13.LevelB.Task03;
...
public class Main {
    public static void main(String[] args) {
        ...
        int counter = Model.countEqualsNumberElements(array, number);

        String msg = String.format("\nAmount of equals number elements: %d", counter);
