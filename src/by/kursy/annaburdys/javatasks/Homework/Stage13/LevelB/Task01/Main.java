package by.kursy.annaburdys.javatasks.Homework.Stage13.LevelB.Task01;
...
public class Main {
    public static void main(String[] args) {
        ...
        int counter = Model.countMoreThanNumberElements(array, number);
        String msg = String.format("\nAmount of more than number elements: %d", counter);
