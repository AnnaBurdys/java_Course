package by.kursy.annaburdys.javatasks.Homework.Stage13.LevelB.Task04;
...
public class Main {
    public static void main(String[] args) {
        ...
        int counter = Model.countNotEqualsNumberElements(array, number);

        String msg = String.format("\nAmount of not equals number elements: %d", counter);
