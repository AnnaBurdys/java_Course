package by.kursy.annaburdys.javatasks.Homework.Stage13.LevelB.Task06;
...
public class Main {
    public static void main(String[] args) {
        ...
        int counter = Model.countNotAliquotNumberElements(array, number);

        String msg = String.format("\nAmount of not aliquot number elements: %d", counter);
