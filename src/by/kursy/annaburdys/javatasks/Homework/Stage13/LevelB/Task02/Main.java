package by.kursy.annaburdys.javatasks.Homework.Stage13.LevelB.Task02;
...
public class Main {
    public static void main(String[] args) {
        ...
        int counter = Model.countLessThanNumberElements(array, number);
        String msg = String.format("\nAmount of less than number elements: %d", counter);
