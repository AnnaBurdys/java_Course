package by.kursy.annaburdys.javatasks.Homework.Stage13.LevelB.Task09;
...
public class Main {
    public static void main(String[] args) {
        ...
        int counter = Model.countAbsEqualsNumberElements(array, number);

        String msg = String.format("\nAmount of abs equals number elements: %d", counter);
