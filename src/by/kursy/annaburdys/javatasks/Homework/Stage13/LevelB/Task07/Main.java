package by.kursy.annaburdys.javatasks.Homework.Stage13.LevelB.Task07;
...
public class Main {
    public static void main(String[] args) {
        ...
        int counter = Model.countAbsMoreThanNumberElements(array, number);

        String msg = String.format("\nAmount of abs more than number elements: %d", counter);
