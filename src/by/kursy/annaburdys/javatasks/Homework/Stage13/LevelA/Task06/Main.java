package by.kursy.annaburdys.javatasks.Homework.Stage13.LevelA.Task06;
...
public class Main {
    public static void main(String[] args) {
        ...
        int counter = Model.countNegativeElements(array);
        Printer.print(Arrays.toString(array));
        String msg = String.format("\nAmount of negative elements: %d", counter);
