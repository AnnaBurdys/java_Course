package by.kursy.annaburdys.javatasks.Homework.Stage13.LevelF.Task11.Task12;
...
public class Main {
    public static void main(String[] args) {
        ...
        Printer.print("\nEnter a number to sort array until it:");
        int number = scanner.nextInt();
        Model.sortDescUntilNumber(array, number);
        Printer.print("Sort descending until number:\n");
        Printer.print(Arrays.toString(array));
    }
}