package by.kursy.annaburdys.javatasks.Homework.Stage13.LevelC.Task06;
...
public class Main {
    public static void main(String[] args) {
        ...
        int counter = Model.countEqualsGeometricAverageAmount(array, number);
        String msg = String.format("\nAmount of more-less equals geometric average number elements: %d", counter);
