package by.kursy.annaburdys.javatasks.Homework.Stage13.LevelC.Task03;
...
public class Main {
    public static void main(String[] args) {
        ...
        int counter = Model.countLessThanAverageAmount(array);
        String msg = String.format("\nAmount of less than average number elements: %d", counter);
