package by.kursy.annaburdys.javatasks.Homework.Stage13.LevelC.Task04;
...
public class Main {
    public static void main(String[] args) {
        ...
        int counter = Model.countLessThanGeometricAverageAmount(array);
        String msg = String.format("\nAmount of less than geometric average elements: %d", counter);
