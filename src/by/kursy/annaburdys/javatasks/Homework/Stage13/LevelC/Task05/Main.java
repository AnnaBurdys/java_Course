package by.kursy.annaburdys.javatasks.Homework.Stage13.LevelC.Task05;
...
public class Main {
    public static void main(String[] args) {
        ...
        int counter = Model.countEqualsAverageAmount(array, number);
        String msg = String.format("\nAmount of more-less equals average number elements: %d", counter);
