package by.kursy.annaburdys.javatasks.Homework.Stage13.LevelC.Task02;
...
public class Main {
    public static void main(String[] args) {
        ...
        int counter = Model.countMoreThanGeometricAverageAmount(array);
        String msg = String.format("\nAmount of more than geometric number elements: %d", counter);
