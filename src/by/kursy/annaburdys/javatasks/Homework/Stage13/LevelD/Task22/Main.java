package by.kursy.annaburdys.javatasks.Homework.Stage13.LevelD.Task22;
...
public class Main {
    public static void main(String[] args) {
        ...
        boolean result = Model.areOddMinority(array);
        String msg = String.format("\nThe minority of elements are odd: %s", result);
