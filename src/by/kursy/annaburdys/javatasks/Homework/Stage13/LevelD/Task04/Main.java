package by.kursy.annaburdys.javatasks.Homework.Stage13.LevelD.Task04;
...
public class Main {
    public static void main(String[] args) {
        ...
        boolean result = Model.areOppositeOnce(array);
        String msg = String.format("\nAll elements are opposite at least once: %s", result);
