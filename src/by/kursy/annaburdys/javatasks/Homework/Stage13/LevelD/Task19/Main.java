package by.kursy.annaburdys.javatasks.Homework.Stage13.LevelD.Task19;
...
public class Main {
    public static void main(String[] args) {
        ...
        boolean result = Model.areOddMajority(array);
        String msg = String.format("\nThe majority of elements are odd: %s", result);
