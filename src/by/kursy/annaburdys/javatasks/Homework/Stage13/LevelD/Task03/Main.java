package by.kursy.annaburdys.javatasks.Homework.Stage13.LevelD.Task03;
...
public class Main {
    public static void main(String[] args) {
        ...
        boolean result = Model.areSameOnce(array);
        String msg = String.format("\nAll elements are the same at least once: %s", result);
