package by.kursy.annaburdys.javatasks.Homework.Stage13.LevelD.Task16;
...
public class Main {
    public static void main(String[] args) {
        ...
        boolean result = Model.areNegativeMinority(array);
        String msg = String.format("\nThe minority of elements are negative: %s", result);
