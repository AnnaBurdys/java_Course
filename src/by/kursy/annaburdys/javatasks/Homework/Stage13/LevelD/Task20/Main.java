package by.kursy.annaburdys.javatasks.Homework.Stage13.LevelD.Task20;
...
public class Main {
    public static void main(String[] args) {
        ...
        boolean result = Model.areEvenMajority(array);
        String msg = String.format("\nThe majority of elements are even: %s", result);
