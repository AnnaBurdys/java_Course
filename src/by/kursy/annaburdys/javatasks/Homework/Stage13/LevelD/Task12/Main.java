package by.kursy.annaburdys.javatasks.Homework.Stage13.LevelD.Task12;
...
public class Main {
    public static void main(String[] args) {
        ...
        boolean result = Model.isOneNegative(array);
        String msg = String.format("\nThere is only one negative element: %s", result);
