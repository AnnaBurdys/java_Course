package by.kursy.annaburdys.javatasks.Homework.Stage13.LevelD.Task27;
...
public class Main {
    public static void main(String[] args) {
        ...
        boolean result = Model.areOfOneOdd(array);
        String msg = String.format("\nAll elements are either all odd or all even: %s", result);
