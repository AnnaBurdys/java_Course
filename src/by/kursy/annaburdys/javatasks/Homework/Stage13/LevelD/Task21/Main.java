package by.kursy.annaburdys.javatasks.Homework.Stage13.LevelD.Task21;
...
public class Main {
    public static void main(String[] args) {
        ...
        boolean result = Model.areEvenMinority(array);
        String msg = String.format("\nThe minority of elements are even: %s", result);
