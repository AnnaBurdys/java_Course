package by.kursy.annaburdys.javatasks.Homework.Stage13.LevelD.Task10;
...
public class Main {
    public static void main(String[] args) {
        ...
        boolean result = Model.isNegativeOnce(array);
        String msg = String.format("\nThere is at least one negative element: %s", result);
