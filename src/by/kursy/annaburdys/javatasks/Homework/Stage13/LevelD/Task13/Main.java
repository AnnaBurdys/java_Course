package by.kursy.annaburdys.javatasks.Homework.Stage13.LevelD.Task13;
...
public class Main {
    public static void main(String[] args) {
        ...
        boolean result = Model.arePositiveMajority(array);
        String msg = String.format("\nThe majority of elements are positive: %s", result);
