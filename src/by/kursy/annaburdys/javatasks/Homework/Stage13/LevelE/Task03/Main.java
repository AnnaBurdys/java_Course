package by.kursy.annaburdys.javatasks.Homework.Stage13.LevelE.Task03;
...
public class Main {
    public static void main(String[] args) {
        ...
        float result = Model.sumElementsUntilLastPositive(array);
        String msg = String.format("\nSum until last positive element: %f", result);
