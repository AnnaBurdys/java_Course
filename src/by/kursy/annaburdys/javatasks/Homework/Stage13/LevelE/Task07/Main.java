package by.kursy.annaburdys.javatasks.Homework.Stage13.LevelE.Task07;
...
public class Main {
    public static void main(String[] args) {
        ...
        float result = Model.sumElementsAfterAbsMax(array);
        String msg = String.format("\nSum after abs maximum number: %f", result);
