package by.kursy.annaburdys.javatasks.Homework.Stage13.LevelE.Task08;
...
public class Main {
    public static void main(String[] args) {
        ...
        float result = Model.sumPositiveElementsBeforeMax(array);
        String msg = String.format("\nSum before maximum number: %f", result);
