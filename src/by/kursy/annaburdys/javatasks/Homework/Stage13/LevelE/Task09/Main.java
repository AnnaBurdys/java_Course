package by.kursy.annaburdys.javatasks.Homework.Stage13.LevelE.Task09;
...
public class Main {
    public static void main(String[] args) {
        ...
        float result = Model.sumElementsBetweenFirstAndLastPositive(array);
        String msg = String.format("\nSum between first and last positive number: %f", result);
