package by.kursy.annaburdys.javatasks.Homework.Stage13.LevelE.Task13;
...
public class Main {
    public static void main(String[] args) {
        ...
        float result = Model.sumElementsBtwFirstAndSecondNegative(array);
        String msg = String.format("\nSum between first and second positive element: %f", result);
