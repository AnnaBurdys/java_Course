package by.kursy.annaburdys.javatasks.Homework.Stage13.LevelE.Task12;
...
public class Main {
    public static void main(String[] args) {
        ...
        float result = Model.sumElementsBetweenFirstAndLastNegative(array);
        String msg = String.format("\nSum between first and last negative element: %f", result);
